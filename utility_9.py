...
if __name__ == "__main__":
    print(f"\n{'='*50}\n[*] Running Utility Service 9 (52059) [Normal Selection + Barcode]...")
    ...
    try:
        ...
        SERVICE_TITLE = S_CFG['UTILITY_9_TITLE']         # 52059
        ...
        # 2. พิมพ์บาร์โค้ด
        # ใช้ ID6 ตาม Config
        BARCODE_ID = S_CFG['BARCODE_INPUT_ID9']      # Barcode_52059
