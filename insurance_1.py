...
def run_insurance_1():
    """Logic สำหรับ Insurance_1 (51014) - กรอกบาร์โค้ด, ข้อมูลส่วนบุคคล, รับเงิน Fast Cash"""
    app = None
    try:
        step_name = "Insurance_1"
        service_title = S_CFG["TRANSACTION_1_TITLE"]
        ...
        # กรอกบาร์โค้ด (Barcode_51014)
        barcode_value = S_CFG["I1_BARCODE"]
        ...
        save_evidence_context(app, {"test_name": "Insurance", "step_name": "Insurance_1", "error_message": str(e)})
        print(f"[X] FAILED: {e}")
