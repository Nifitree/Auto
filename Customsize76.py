...
def find_and_click_with_rotate_logic(window, target_id, max_rotations=20):
    """
...
def run_smart_scenario(main_window, config):
    ...
    target_service_id = "ShippingService_364074" 
