...
def run_smart_scenario(main_window, config):
    try:
        category_name = "กล่องบรรจุผลไม้ขนาด L" 
    ...
    wait_until_id_appears(main_window, "ShippingService_365939", timeout=15)
    if find_and_click_with_rotate_logic(main_window, "ShippingService_365939"):
        main_window.type_keys("{ENTER}")
