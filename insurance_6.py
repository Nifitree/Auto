...
def run_insurance_6():
    """Logic สำหรับ Insurance_6 (52042) - กรอกบาร์โค้ด, ชื่อ-สกุล, ชื่อพนักงานขาย, รับเงิน Fast Cash"""
    app = None
    try:
        step_name = "Insurance_6"
        ...
        # กรอกบาร์โค้ด (Barcode_52042)
        barcode_value = S_CFG["I6_BARCODE"]
        barcode_id = S_CFG["I6_BARCODE_INPUT_ID"]
        ...
        name_edit = main_window.child_window(auto_id=S_CFG["I6_NAME_AUTO_ID"], control_type="Edit")
        fill_if_empty(main_window, name_edit, S_CFG["I6_NAME"])
        
        # กรอกชื่อ-สกุล พนักงานขาย (REFNO5)
        print("[*] Filling Seller Name (REFNO5)...")
        seller_edit = main_window.child_window(auto_id=S_CFG["I6_SELLER_NAME_AUTO_ID"], control_type="Edit")
        fill_if_empty(main_window, seller_edit, S_CFG["I6_SELLER_NAME"])
        ...
        save_evidence_context(app, {"test_name": "Insurance", "step_name": "Insurance_6", "error_message": str(e)})
        print(f"[X] FAILED: {e}")
