...
def run_goodsPM_6_custom():
    step_name = "goodsPM_6 (Custom Flow)"
    app = None
    ...
    try:
        ...
        SERVICE_TITLE = S_CFG['GOODSPM_6_TITLE']        # 50742
        ...
        # 3. กรอกบาร์โค้ด
        barcode_val = S_CFG.get('PM6_BARCODE', '|01005280001272111625877715453486690550')
        # AutoID: Barcode_50742
        fill_field_by_id(main_window, "Barcode_50742", barcode_val, "บาร์โค้ด")
        ...
        # 5.1 AcctNo: RefNo.1
        ref1_val = S_CFG.get('PM6_REF1', '1234567890')
        fill_field_by_id(main_window, "AcctNo", ref1_val, "RefNo.1")

        # 5.2 REFNO6: RefNo.2
        ref2_val = S_CFG.get('PM6_REF2', '0987654321')
        fill_field_by_id(main_window, "REFNO6", ref2_val, "RefNo.2")

        # 5.3 REFNO5: ชื่อลูกค้า
        name_val = S_CFG.get('PM6_NAME', 'Test Customer')
        fill_field_by_id(main_window, "REFNO5", name_val, "ชื่อลูกค้า")

        # 5.4 Amount: จำนวนเงิน
        amt_val = S_CFG.get('PM6_AMOUNT', '100.00')
