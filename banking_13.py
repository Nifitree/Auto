...
BARCODE_VALUE = "|09940001648580001154000435300"
...
def run_banking_1_custom():
    ...
    try:
        ...
        # 3. กรอก Barcode (BARCODE_INPUT_ID13)
        barcode_id = S_CFG["BARCODE_INPUT_ID13"]
        ...
        name_input = window.child_window(auto_id="REFNO4", control_type="Edit")
