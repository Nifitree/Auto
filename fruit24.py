...
def run_smart_scenario(main_window, config):
    try:
        category_name = "ตระกร้าบรรจุผลไม้ 10 กก." 
    ...
    wait_until_id_appears(main_window, "ShippingService_364060", timeout=15)
    if find_and_click_with_rotate_logic(main_window, "ShippingService_364060"):
        main_window.type_keys("{ENTER}")
