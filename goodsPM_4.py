...
def run_goodsPM_4_custom():
    step_name = "goodsPM_4 (Custom Flow)"
    app = None
    ...
    try:
        ...
        SERVICE_TITLE = S_CFG['GOODSPM_4_TITLE']        # 50731
        ...
        # 3. กรอกบาร์โค้ด
        barcode_val = S_CFG.get('PM4_BARCODE', '|011554701290300004125121390290901151213900')
        # AutoID: Barcode_50731
        fill_field_by_id(main_window, "Barcode_50731", barcode_val, "บาร์โค้ด")
        ...
        # 5.1 REFNO5: ชื่อ-สกุล (ตามที่คุณระบุ)
        name_val = S_CFG.get('PM4_NAME', 'Test Name')
        fill_field_by_id(main_window, "REFNO5", name_val, "ชื่อ-สกุล")

        # 5.2 Amount: จำนวนเงิน
        amt_val = S_CFG.get('PM4_AMOUNT', '100.00')
